...
export async function getNotifications(params: { page?: number; pageSize?: number; status?: string }) {
...
export async function getTemplates() {
  return apiFetch<{ success: boolean; data: NotificationTemplate[] }>('/admin/notifications/templates');
}
