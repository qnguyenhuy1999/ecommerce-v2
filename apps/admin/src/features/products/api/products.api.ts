...
export interface ProductDetail extends ProductListItem {
  ...
  weight: string | null;
  variants: {
    id: string; sku: string | null; price: string; stock: number; isActive: boolean;
...
export async function getProductStatusCounts() {
  return apiFetch<{ success: boolean; data: Record<string, number> }>('/admin/products/status-counts');
}
